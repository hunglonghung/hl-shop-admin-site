...
INSERT INTO products (name, description, category, subcategory, price, brand, authenticity_type, is_combo, combo_products, discount_percentage, discounted_price, image_url) VALUES 
('Football Starter Kit', 'Complete football starter kit with boots, ball, and jersey', 'Football', 'Training Equipment', 6000000, 'Adidas', 'authentic', true, ARRAY[(SELECT id FROM products WHERE name = 'Adidas Predator Elite'), (SELECT id FROM products WHERE name = 'FIFA World Cup 2024 Ball'), (SELECT id FROM products WHERE name = 'Manchester United Home Jersey')], 25, 4500000, 'football-kit.jpg');